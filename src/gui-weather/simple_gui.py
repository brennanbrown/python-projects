...
# Adding a label:
ttk.Label(test_frame, text="LABEL: ").grid(column=0, row=0, sticky="W")
# ---------------------

test_label = tk.StringVar()
test_selected = ttk.Combobox(test_frame, width=12, textvariable=test_label)
...
ttk.Label(test_frame, text="Last Updated: ").grid(column=0, row=1, sticky="E")
updated = tk.StringVar()
updated_entry = ttk.Entry(test_frame, width=ENTRY_WIDTH, textvariable=updated, state="readonly")
updated_entry.grid(column=1, row=1, sticky="W")

ttk.Label(test_frame, text="Weather: ").grid(column=0, row=2, sticky="E")
weather = tk.StringVar()
weather_entry = ttk.Entry(test_frame, width=ENTRY_WIDTH, textvariable=weather, state="readonly")
weather_entry.grid(column=1, row=2, sticky="W")

ttk.Label(test_frame, text="Temperature: ").grid(column=0, row=3, sticky="E")
temperature = tk.StringVar()
temperature_entry = ttk.Entry(
    test_frame, width=ENTRY_WIDTH, textvariable=temperature, state="readonly"
)
temperature_entry.grid(column=1, row=3, sticky="W")

ttk.Label(test_frame, text="Dew Point: ").grid(column=0, row=4, sticky="E")
dew_point = tk.StringVar()
dew_point_entry = ttk.Entry(test_frame, width=ENTRY_WIDTH, textvariable=dew_point, state="readonly")
dew_point_entry.grid(column=1, row=4, sticky="W")

ttk.Label(test_frame, text="Relative Humidity: ").grid(column=0, row=5, sticky="E")
humidity = tk.StringVar()
humidity_entry = ttk.Entry(test_frame, width=ENTRY_WIDTH, textvariable=humidity, state="readonly")
